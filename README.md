<div align="center">
  ...
  <img src="https://img.shields.io/static/v1?label=Axios&message=HTTP%20Client&color=5A29E4&style=for-the-badge&logo=axios"/>
...
<h1 align="center">📝 Blog com React + Axios</h1>
...
Aplicação desenvolvida em **React** com **Axios**, durante o curso **Formação Front-end - HTML, CSS, JavaScript, React e +**, da Comunidade Hora de Codar. O projeto simula um ambiente completo de blog, com criação, edição, visualização e administração de postagens, utilizando rotas dinâmicas e gerenciamento de dados via API.

---

### ✅ Funcionalidades

- 📰 **Visualizar posts em destaque na home**
- ➕ **Criar novos posts**
- 🛠️ **Editar e gerenciar posts existentes**
- 🔍 **Visualizar postagens completas por ID**
...
<div align="center">
  <img src="./public/screen-movie.gif" width="430px"> 
    <br/>
...
```sh
https://github.com/domfabio/Blog-com-React-Axios.git
```
